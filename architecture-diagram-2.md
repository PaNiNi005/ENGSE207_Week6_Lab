...
### Overview
สถาปัตยกรรมแบบ Client–Server แยกส่วนการทำงานระหว่าง Frontend และ Backend อย่างชัดเจน  
Frontend ติดต่อกับ Backend ผ่าน REST API  
เหมาะสำหรับระบบที่มีแนวโน้มขยายในอนาคตและรองรับผู้ใช้งานจำนวนมากขึ้น
...
![Architecture Diagram](https://github.com/user-attachments/assets/b3f805bd-7c70-4e92-a18a-2a3511aac745)
